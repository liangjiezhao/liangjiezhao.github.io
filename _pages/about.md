...
- Adapted self-developed large models to various chip platforms (Qualcomm, MediaTek) for on-device PTQ, establishing a stable engineering foundation.
- Participated in the development of Quantization-Aware LoRA Fine-Tuning (QALFT).
- Investigated hallucination phenomena in quantized large models, systematically evaluating the impact of different quantization precisions on hallucination metrics.
- Designed innovative post-training algorithms with hallucination-awareness.
